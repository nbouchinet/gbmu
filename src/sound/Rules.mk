...
src/sound/$(OBJECT_DIR)/APU.o: src/sound/APU.cpp src/sound/APU.hpp \
  ...
  src/sound/VolumeTable.hpp src/sound/NoiseChannel.hpp \
  src/sound/SoundChannel.hpp src/sound/ModulationUnits.hpp \
  src/sound/SquareChannel.hpp src/sound/WaveChannel.hpp \
...
src/sound/$(OBJECT_DIR)/WaveChannel.o: src/sound/WaveChannel.cpp \
  src/sound/WaveChannel.hpp src/sound/ModulationUnits.hpp src/Fwd.hpp \
  src/sound/SoundChannel.hpp src/IReadWrite.hpp \
  src/sound/VolumeTable.hpp
