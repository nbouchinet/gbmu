...
class Debugger {
	...
	private:
		...
		std::map<int, _instr_info> _instr_map = {
			...
			{0xCB3D, {"srl L", 1}}, {0xCB3E, {"srl (HL)", 1}}, {0xCB47, {"bit A,0", 1}}, {0xCB4F, {"bit A,1", 1}}, 
			{0xCB57, {"bit 2,A", 1}}, {0xCB5F, {"bit A,3", 1}}, {0xCB67, {"bit A,4", 1}}, {0xCB6F, {"bit A,5", 1}}, 
			{0xCB77, {"bit A,6", 1}}, {0xCB7F, {"bit A,7", 1}}, {0xCB40, {"bit B,0", 1}}, {0xCB48, {"bit B,1", 1}}, 
			{0xCB50, {"bit B,2", 1}}, {0xCB58, {"bit B,3", 1}}, {0xCB60, {"bit B,4", 1}}, {0xCB68, {"bit B,5", 1}}, 
			{0xCB70, {"bit B,6", 1}}, {0xCB78, {"bit B,7", 1}}, {0xCB41, {"bit C,0", 1}}, {0xCB49, {"bit C,1", 1}}, 
			{0xCB51, {"bit C,2", 1}}, {0xCB59, {"bit C,3", 1}}, {0xCB61, {"bit C,4", 1}}, {0xCB69, {"bit C,5", 1}}, 
			{0xCB71, {"bit C,6", 1}}, {0xCB79, {"bit C,7", 1}}, {0xCB42, {"bit D,0", 1}}, {0xCB4A, {"bit D,1", 1}}, 
			{0xCB52, {"bit D,2", 1}}, {0xCB5A, {"bit D,3", 1}}, {0xCB62, {"bit D,4", 1}}, {0xCB6A, {"bit D,5", 1}}, 
			{0xCB72, {"bit D,6", 1}}, {0xCB7A, {"bit D,7", 1}}, {0xCB43, {"bit E,0", 1}}, {0xCB4B, {"bit E,1", 1}}, 
			{0xCB53, {"bit E,2", 1}}, {0xCB5B, {"bit E,3", 1}}, {0xCB63, {"bit E,4", 1}}, {0xCB6B, {"bit E,5", 1}}, 
			{0xCB73, {"bit E,6", 1}}, {0xCB7B, {"bit E,7", 1}}, {0xCB44, {"bit H,0", 1}}, {0xCB4C, {"bit H,1", 1}}, 
			{0xCB54, {"bit H,2", 1}}, {0xCB5C, {"bit H,3", 1}}, {0xCB64, {"bit H,4", 1}}, {0xCB6C, {"bit H,5", 1}}, 
			{0xCB74, {"bit H,6", 1}}, {0xCB7C, {"bit H,7", 1}}, {0xCB45, {"bit L,0", 1}}, {0xCB4D, {"bit L,1", 1}}, 
			{0xCB55, {"bit L,2", 1}}, {0xCB5D, {"bit L,3", 1}}, {0xCB65, {"bit L,4", 1}}, {0xCB6D, {"bit L,5", 1}}, 
			{0xCB75, {"bit L,6", 1}}, {0xCB7D, {"bit L,7", 1}}, {0xCB46, {"bit (HL),0", 1}}, {0xCB4E, {"bit (HL),1", 1}}, 
			{0xCB56, {"bit (HL),2", 1}}, {0xCB5E, {"bit (HL),3", 1}}, {0xCB66, {"bit (HL),4", 1}}, {0xCB6E, {"bit (HL),5", 1}}, 
			{0xCB76, {"bit (HL),6", 1}}, {0xCB7E, {"bit (HL),7", 1}}, {0xCB80, {"res B,0", 1}}, {0xCB81, {"res C,0", 1}}, 
			{0xCB82, {"res D,0", 1}}, {0xCB83, {"res E,0", 1}}, {0xCB84, {"res H,0", 1}}, {0xCB85, {"res L,0", 1}}, 
			{0xCB86, {"res (HL),0", 1}}, {0xCB87, {"res A,0", 1}}, {0xCB88, {"res B,1", 1}}, {0xCB89, {"res C,1", 1}}, 
			{0xCB8A, {"res D,1", 1}}, {0xCB8B, {"res E,1", 1}}, {0xCB8C, {"res H,1", 1}}, {0xCB8D, {"res L,1", 1}}, 
			{0xCB8E, {"res (HL),1", 1}}, {0xCB8F, {"res A,1", 1}}, {0xCB90, {"res B,2", 1}}, {0xCB91, {"res C,2", 1}}, 
			{0xCB92, {"res D,2", 1}}, {0xCB93, {"res E,2", 1}}, {0xCB94, {"res H,2", 1}}, {0xCB95, {"res L,2", 1}}, 
			{0xCB96, {"res (HL),2", 1}}, {0xCB97, {"res A,2", 1}}, {0xCB98, {"res B,3", 1}}, {0xCB99, {"res C,3", 1}}, 
			{0xCB9A, {"res D,3", 1}}, {0xCB9B, {"res E,3", 1}}, {0xCB9C, {"res H,3", 1}}, {0xCB9D, {"res L,3", 1}}, 
			{0xCB9E, {"res (HL),3", 1}}, {0xCB9F, {"res A,3", 1}}, {0xCBA0, {"res B,4", 1}}, {0xCBA1, {"res C,4", 1}}, 
			{0xCBA2, {"res D,4", 1}}, {0xCBA3, {"res E,4", 1}}, {0xCBA4, {"res H,4", 1}}, {0xCBA5, {"res L,4", 1}}, 
			{0xCBA6, {"res (HL),4", 1}}, {0xCBA7, {"res A,4", 1}}, {0xCBA8, {"res B,5", 1}}, {0xCBA9, {"res C,5", 1}}, 
			{0xCBAA, {"res D,5", 1}}, {0xCBAB, {"res E,5", 1}}, {0xCBAC, {"res H,5", 1}}, {0xCBAD, {"res L,5", 1}}, 
			{0xCBAE, {"res (HL),5", 1}}, {0xCBAF, {"res A,5", 1}}, {0xCBB0, {"res B,6", 1}}, {0xCBB1, {"res C,6", 1}}, 
			{0xCBB2, {"res D,6", 1}}, {0xCBB3, {"res E,6", 1}}, {0xCBB4, {"res H,6", 1}}, {0xCBB5, {"res L,6", 1}}, 
			{0xCBB6, {"res (HL),6", 1}}, {0xCBB7, {"res A,6", 1}}, {0xCBB8, {"res B,7", 1}}, {0xCBB9, {"res C,7", 1}}, 
			{0xCBBA, {"res D,7", 1}}, {0xCBBB, {"res E,7", 1}}, {0xCBBC, {"res H,7", 1}}, {0xCBBD, {"res L,7", 1}}, 
			{0xCBBE, {"res (HL),7", 1}}, {0xCBBF, {"res A,7", 1}}, {0xCBC0, {"set B,0", 1}}, {0xCBC1, {"set C,0", 1}}, 
			{0xCBC2, {"set D,0", 1}}, {0xCBC3, {"set E,0", 1}}, {0xCBC4, {"set H,0", 1}}, {0xCBC5, {"set L,0", 1}}, 
			{0xCBC6, {"set (HL),0", 1}}, {0xCBC7, {"set A,0", 1}}, {0xCBC8, {"set B,1", 1}}, {0xCBC9, {"set C,1", 1}}, 
			{0xCBCA, {"set D,1", 1}}, {0xCBCC, {"set H,1", 1}}, {0xCBCD, {"set L,1", 1}}, {0xCBCE, {"set (HL),1", 1}}, 
			{0xCBCF, {"set A,1", 1}}, {0xCBD0, {"set B,2", 1}}, {0xCBD1, {"set C,2", 1}}, {0xCBD2, {"set D,2", 1}}, 
			{0xCBD3, {"set E,2", 1}}, {0xCBD4, {"set H,2", 1}}, {0xCBD5, {"set L,2", 1}}, {0xCBD6, {"set (HL),2", 1}}, 
			{0xCBD7, {"set A,2", 1}}, {0xCBD8, {"set B,3", 1}}, {0xCBD9, {"set C,3", 1}}, {0xCBDA, {"set D,3", 1}}, 
			{0xCBDB, {"set E,3", 1}}, {0xCBDC, {"set H,3", 1}}, {0xCBDD, {"set L,3", 1}}, {0xCBDE, {"set (HL),3", 1}}, 
			{0xCBDF, {"set A,3", 1}}, {0xCBE0, {"set B,4", 1}}, {0xCBE1, {"set C,4", 1}}, {0xCBE2, {"set D,4", 1}}, 
			{0xCBE3, {"set E,4", 1}}, {0xCBE4, {"set H,4", 1}}, {0xCBE5, {"set L,4", 1}}, {0xCBE6, {"set (HL),4", 1}}, 
			{0xCBE7, {"set A,4", 1}}, {0xCBE8, {"set B,5", 1}}, {0xCBE9, {"set C,5", 1}}, {0xCBEA, {"set D,5", 1}}, 
			{0xCBEB, {"set E,5", 1}}, {0xCBEC, {"set H,5", 1}}, {0xCBED, {"set L,5", 1}}, {0xCBEE, {"set (HL),5", 1}}, 
			{0xCBEF, {"set A,5", 1}}, {0xCBF0, {"set B,6", 1}}, {0xCBF1, {"set C,6", 1}}, {0xCBF2, {"set D,6", 1}}, 
			{0xCBF3, {"set E,6", 1}}, {0xCBF4, {"set H,6", 1}}, {0xCBF5, {"set L,6", 1}}, {0xCBF6, {"set (HL),6", 1}}, 
			{0xCBF7, {"set A,6", 1}}, {0xCBF8, {"set B,7", 1}}, {0xCBF9, {"set C,7", 1}}, {0xCBFA, {"set D,7", 1}}, 
			{0xCBFB, {"set E,7", 1}}, {0xCBFC, {"set H,7", 1}}, {0xCBFD, {"set L,7", 1}}, {0xCBFE, {"set (HL),7", 1}}, 
			{0xCBFF, {"set A,7", 1}}, };
